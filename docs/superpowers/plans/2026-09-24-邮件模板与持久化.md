...
```bash
git add pom.xml src/main/resources/application.yaml .gitignore
...
- [ ] **Step 1: 在 `GotifyConfig` 的 `Mail` 接口中增加阈值字段**
...
```bash
git add src/main/java/com/github/luobai0110/MailDispatcher.java src/main/java/com/github/luobai0110/MessageService.java src/main/java/com/github/luobai0110/GotifyConfig.java
